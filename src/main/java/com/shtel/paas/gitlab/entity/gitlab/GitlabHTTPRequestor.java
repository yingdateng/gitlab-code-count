...
public class GitlabHTTPRequestor {
    ...
    public <T> T toAT(String tailAPIUrl, Class<T> type) throws IOException {
        return toAT(tailAPIUrl, type, null);
    }

    public <T> T toAT(String tailAPIUrl, Class<T> type, T instance) throws IOException {
        HttpURLConnection connection = null;
        try {
            connection = setupConnection(root.getUrl(tailAPIUrl));
            if (hasAttachments()) {
